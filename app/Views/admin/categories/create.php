...
<div class="main">
    <div class="mb-3">
        <a href="/admin/categories" style="color:#94a3b8;text-decoration:none;font-size:0.9rem">← Back to Categories</a>
    </div>

    <div class="form-card">
        <h2 style="font-size:1.2rem;font-weight:700;margin-bottom:1.5rem">New Category</h2>
        ...
        <form action="/admin/categories/create" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" value="<?= esc(old('name')) ?>" placeholder="e.g. Teaching Quality" required>
            </div>
            ...
            <button type="submit" class="btn w-100" style="background:#6366f1;color:#fff;border-radius:8px;font-weight:600">Create Category</button>
        </form>
    </div>
</div>
</body>
