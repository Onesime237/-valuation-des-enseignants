...
<div class="main">
    ...
    <div class="form-card">
        <h2 style="font-size:1.2rem;font-weight:700;margin-bottom:1.5rem">Edit Category</h2>
        ...
        <form action="/admin/categories/edit/<?= esc($category['id']) ?>" method="POST">
            <?= csrf_field() ?>
            ...
            <button type="submit" class="btn w-100" style="background:#6366f1;color:#fff;border-radius:8px;font-weight:600">Update Category</button>
        </form>
    </div>
</div>
</body>
