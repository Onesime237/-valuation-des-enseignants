...
<div class="main">
    <div class="form-card">
        <h4 class="mb-4">Create Student Account</h4>
        ...
        <form action="/admin/students/create" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control"
                       value="<?= esc(old('name')) ?>" placeholder="Jane Doe" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Email</label>
                <input type="email" name="email" class="form-control"
                       value="<?= esc(old('email')) ?>" placeholder="student@school.cm" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Matricule</label>
                <input type="text" name="matricule" class="form-control"
                       value="<?= esc(old('matricule')) ?>" placeholder="ETU001" required>
            </div>
            ...
            <div class="d-flex gap-3">
                ...
                <a href="/admin/students" class="btn-back">Cancel</a>
            </div>
        </form>
    </div>
</div>
