...
<head>
    ...
    <style>
        ...
        .form-text { color: #64748b; font-size: 0.8rem; }
...
<div class="main">
    <div class="form-card">
        ...
        <form action="/admin/students/edit/<?= esc($student['id']) ?>" method="POST">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control"
                       value="<?= esc(old('email', $student['email'])) ?>" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Matricule</label>
                <input type="text" name="matricule" class="form-control"
                       value="<?= esc(old('matricule', $student['matricule'])) ?>" required>
            </div>
