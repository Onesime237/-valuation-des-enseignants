...
<head>
    ...
    <style>
        ...
        .table { color: #f1f5f9; }
        .table thead th { background: #0f172a; border-color: #334155; color: #94a3b8; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em; }
        ...
        .btn-create { background: #6366f1; border: none; color: #fff; border-radius: 8px; padding: 0.5rem 1.2rem; font-size: 0.875rem; font-weight: 600; text-decoration: none; }
...
<div class="topbar">
    ...
    <div class="d-flex align-items-center gap-4">
        ...
        <a href="/admin/students" class="nav-link active">Students</a>
...
<div class="main">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="/admin/students/create" class="btn-create">+ New Student</a>
    </div>
                        ...
                        <?php foreach ($students as $student): ?>
                            <tr>
                                ...
                                <td class="d-flex gap-2">
                                    <a href="/admin/students/edit/<?= $student['id'] ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                                    <a href="/admin/students/toggle/<?= $student['id'] ?>" class="btn btn-sm <?= $student['is_active'] ? 'btn-outline-warning' : 'btn-outline-success' ?>">
